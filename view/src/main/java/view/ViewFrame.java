                ...
                public void actionPerformed(ActionEvent arg0) {
                  // TODO Auto-generated method stub
                      showNewFrame();
                            ...
                            ////////////////////////////////////////////////////////////
                            JButton S=new JButton("Map 1");  
                            Lab.add(S);
                            S.setBounds(345,350,100,40); 
                                ...
                                S.addActionListener(new ActionListener()            
                        {
                          ...
                          JButton B=new JButton("Map 2");  
                            B.setBounds(345,400,100,40);  
                            Lab.add(B);     
                            frame.setVisible(true); 
                            B.setBackground(Color.RED);
                            B.setForeground(Color.BLACK);
                            
                            JButton C=new JButton("Map 3");  
                            C.setBounds(345,450,100,40);  
                            Lab.add(C);     
                            frame.setVisible(true); 
                            C.setBackground(Color.RED);
                            C.setForeground(Color.BLACK);
                       
                            JButton D=new JButton("Map 4");  
                            D.setBounds(345,500,100,40);  
                            Lab.add(D);     
                            frame.setVisible(true); 
                            D.setBackground(Color.RED);
                            D.setForeground(Color.BLACK);
                            
                            JButton E=new JButton("Map 5");  
                            E.setBounds(345,550,100,40);  
                            Lab.add(E);     
                            frame.setVisible(true); 
